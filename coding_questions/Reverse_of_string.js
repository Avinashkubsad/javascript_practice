...
console.log(reverseString("Avinash")); // Output: hsanivA


//2,using Recursion
//“I recursively call the function on the substring starting from the 2nd character, 
// and add the first character at the end each time.”
function reverseString(str) {
  if (str === "") return "";
